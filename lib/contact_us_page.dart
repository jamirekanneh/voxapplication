...
class _ContactUsPageState extends State<ContactUsPage> {
        ...
        builder: (_, sc) => Column(
          children: [
            ...
            Padding(
              ...
              child: TextField(
                autofocus: true,
                style: TextStyle(color: VoxColors.inputText(context)),
                decoration: InputDecoration(
                  ...
                  filled: true,
                  fillColor: VoxColors.inputFill(context),
  ...
  InputDecoration _inputDeco({Widget? prefix, Widget? suffix}) =>
      InputDecoration(
        ...
        fillColor: VoxColors.inputFill(context),
        hintStyle: TextStyle(color: VoxColors.textHint(context)),
        errorStyle: const TextStyle(color: VoxColors.danger),
        contentPadding: const EdgeInsets.symmetric(
          horizontal: 16,
          vertical: 14,
        ),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          height: 52,
          decoration: BoxDecoration(
            color: VoxColors.inputFill(context),
                                    ...
                                    Stack(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          ...
                                          style: TextStyle(
                                            color: VoxColors.inputText(context),
                                          ),
                                          textCapitalization:
