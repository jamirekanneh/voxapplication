            ...
            Expanded(
              child: Text(title,
                  style: TextStyle(
                      ...
                      fontWeight: FontWeight.w600,
                      color:
                          isDanger ? Colors.white : Colors.black87)),
            ),
            if (trailing != null)
              Text(trailing,
                  style: const TextStyle(
                    ...
                    onTap: () {
                      if (!_hasProfile || _isFirebaseAnonymous) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                                'Sign in with email link or Google to access deleted files.'),
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: SizedBox(
          ...
          child: Row(
            ...
            children: [
              _navItem(Icons.home, lang.t('nav_home'),
                  Colors.grey[400]!,
                  onTap: () =>
              ...
              _navItem(Icons.book, lang.t('nav_dictionary'),
                  ...
                  onTap: () => Navigator.pushReplacementNamed(
                      context, '/dictionary')),
              _navItem(
                  Icons.menu, lang.t('nav_menu'), Colors.white),
            ],
          ),
        ),
      ),
...
class DeletedFilesPage extends StatelessWidget {
  ...
  Color _colorForType(String type) {
    switch (type.toLowerCase()) {
      ...
      case 'epub': return Colors.purple.shade400;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF3E5AB),
      appBar: AppBar(
        title: const Text('Deleted Files',
            style: TextStyle(
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final data = doc.data() as Map<String, dynamic>;
              final name =
                  data['fileName'] as String? ?? 'Unknown';
              ...
              return Container(
                ...
                child: ListTile(
                  ...
                  leading: Container(
                    ...
                    decoration: BoxDecoration(
                        color:
                            _colorForType(type).withOpacity(0.12),
                        borderRadius: BorderRadius.circular(10)),
                    child: Icon(_iconForType(type),
                        color: _colorForType(type), size: 24),
                  ),
                  title: Text(name,
                      style: const TextStyle(
                          fontWeight: FontWeight.w600,
                      ...
                      Tooltip(
                        ...
                        child: IconButton(
                          icon: const Icon(Icons.restore,
                              color: Color(0xFFD4B96A), size: 24),
